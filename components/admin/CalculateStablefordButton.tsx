...
export default function CalculateStablefordButton({
  competitionId,
}: {
  ...
  async function calculate() {
    ...
    const response = await fetch("/api/admin/competitions/calculate-stableford", {
      method: "POST",
      headers: {
  ...
  return (
    <div className="mt-3">
      ...
      >
        {isCalculating ? "Calculating..." : "Calculate Stableford"}
      </button>
